...
import {
  ...
  grantLeaveInBulkResponseSchema,
  grantLeaveRequestSchema,
  leaveBalanceListSchema,
  leaveExpirationListSchema,
  leaveGrantPreviewSchema,
  leaveGrantRuleListSchema,
  leaveGrantRuleSchema,
  leaveGrantRunListSchema,
  leaveLedgerEntrySchema,
  leaveLedgerListSchema,
  leaveRegisterListSchema,
...
export const operations = {
  ...
  importWorkCategoriesCsv: {
    operationId: 'importWorkCategoriesCsv',
    method: 'post',
    path: '/work-categories/imports',
    summary: '勤務区分を CSV で取り込む（1 行でも読めなければ何も取り込まない）',
    tags: ['schedule'],
    security: 'session',
    requestBody: { type: 'string', description: 'CSV の本文' },
    responses: [
      { status: 200, description: '取り込んだ件数', schema: importResultSchema },
      invalidRequest,
      unauthorized,
      forbidden,
      conflict,
  ...
  importRequestTypesCsv: {
    operationId: 'importRequestTypesCsv',
    method: 'post',
    path: '/request-types/imports',
    summary: '申請種別を CSV で取り込む（1 行でも読めなければ何も取り込まない）',
    tags: ['request'],
    security: 'session',
    requestBody: { type: 'string', description: 'CSV の本文' },
    responses: [
  ...
  listLeaveGrantRules: {
    operationId: 'listLeaveGrantRules',
    method: 'get',
    path: '/leave-grant-rules',
    summary: '休暇の付与規則を一覧する',
    tags: ['leave'],
    security: 'session',
    query: listLeaveGrantRulesQuerySchema,
    responses: [
      { status: 200, description: '付与規則', schema: leaveGrantRuleListSchema },
      invalidRequest,
      unauthorized,
      forbidden,
    ],
  },
  createLeaveGrantRule: {
    operationId: 'createLeaveGrantRule',
    method: 'post',
    path: '/leave-grant-rules',
    summary: '勤続の段ごとの付与分数を置く',
    tags: ['leave'],
    security: 'session',
    requestBody: createLeaveGrantRuleRequestSchema,
    responses: [
      { status: 201, description: '置いた段', schema: leaveGrantRuleSchema },
      invalidRequest,
      unauthorized,
      forbidden,
      conflict,
  ...
  getApprovalRoute: {
    ...
    method: 'get',
    path: '/request-types/{requestTypeId}/approval-route',
    summary: '申請種別の段ごとの承認者を読む',
    tags: ['request'],
    security: 'session',
    responses: [
      { status: 200, description: '段ごとの承認者', schema: approvalRouteSchema },
      unauthorized,
      forbidden,
      { status: 404, description: '申請種別が見つからない', schema: errorResponseSchema },
    ],
  },
  replaceApprovalRoute: {
    operationId: 'replaceApprovalRoute',
    method: 'put',
    path: '/request-types/{requestTypeId}/approval-route',
    summary: '申請種別の段ごとの承認者を置き換える',
    tags: ['request'],
    security: 'session',
    requestBody: replaceApprovalRouteRequestSchema,
    responses: [
      { status: 200, description: '置き換えた経路', schema: approvalRouteSchema },
      invalidRequest,
      unauthorized,
      forbidden,
      { status: 404, description: '申請種別が見つからない', schema: errorResponseSchema },
  ...
  listApprovalDelegations: {
    ...
    security: 'session',
    responses: [
      { status: 200, description: '委任', schema: approvalDelegationListSchema },
      unauthorized,
      forbidden,
    ],
  },
  createApprovalDelegation: {
    ...
    method: 'post',
    path: '/approval-delegations',
    summary: '承認を代理で決裁できるようにする',
    tags: ['request'],
    security: 'session',
    requestBody: createApprovalDelegationRequestSchema,
    responses: [
      { status: 201, description: '作った委任', schema: approvalDelegationSchema },
      invalidRequest,
      unauthorized,
      forbidden,
  ...
  listLeaveGrantRuns: {
    operationId: 'listLeaveGrantRuns',
    method: 'get',
    path: '/leave-grant-runs',
    summary: '自動付与を処理した日を一覧する',
    tags: ['leave'],
    security: 'session',
    query: listLeaveGrantRunsQuerySchema,
    responses: [
      { status: 200, description: '処理した日', schema: leaveGrantRunListSchema },
      invalidRequest,
      unauthorized,
      forbidden,
    ],
  ...
  previewLeaveGrants: {
    operationId: 'previewLeaveGrants',
    method: 'get',
    path: '/leave-grant-runs/preview',
    summary: '次に自動付与の対象になる日と人数を出す',
    tags: ['leave'],
    security: 'session',
    query: listLeaveGrantRunsQuerySchema,
    responses: [
      { status: 200, description: '次の対象', schema: leaveGrantPreviewSchema },
      invalidRequest,
      unauthorized,
      forbidden,
      { status: 404, description: '休暇種別が見つからない', schema: errorResponseSchema },
  ...
  runLeaveGrants: {
    operationId: 'runLeaveGrants',
    method: 'post',
    path: '/leave-grant-runs',
    summary: '自動付与を、いまの時点で動かす',
    tags: ['leave'],
    security: 'session',
    responses: [
      { status: 200, description: '処理した日ごとの件数', schema: runLeaveGrantsResponseSchema },
      unauthorized,
      forbidden,
    ],
  },
  grantLeaveInBulk: {
    operationId: 'grantLeaveInBulk',
    method: 'post',
    path: '/leave-ledger/bulk-grants',
    summary: '規則に従って、まとめて付与する（自動付与・一斉付与）',
    tags: ['leave'],
    security: 'session',
    requestBody: grantLeaveInBulkRequestSchema,
    responses: [
      {
        status: 200,
        description: '積んだ付与と、付与しなかった相手',
        schema: grantLeaveInBulkResponseSchema,
      },
      invalidRequest,
      unauthorized,
      forbidden,
  ...
  importLeaveGrantsCsv: {
    operationId: 'importLeaveGrantsCsv',
    method: 'post',
    path: '/leave-ledger/imports',
    summary: '休暇の付与を CSV で取り込む（1 行でも読めなければ何も取り込まない）',
    tags: ['leave'],
    security: 'session',
    requestBody: { type: 'string', description: 'CSV の本文' },
    responses: [
  ...
  listLeaveExpirations: {
    operationId: 'listLeaveExpirations',
    method: 'get',
    path: '/leave-expirations',
    summary: 'ある日までに失効する付与を一覧する',
    tags: ['leave'],
    security: 'sessionOrApiKey',
    query: listLeaveExpirationsQuerySchema,
    responses: [
      { status: 200, description: '失効の予定', schema: leaveExpirationListSchema },
      invalidRequest,
      unauthorized,
      forbidden,
    ],
  ...
  listLeaveRegister: {
    operationId: 'listLeaveRegister',
    method: 'get',
    path: '/leave-register',
    summary: '休暇管理簿（期首・付与・消化・失効・期末）を一覧する',
    tags: ['leave'],
    security: 'sessionOrApiKey',
    query: listLeaveRegisterQuerySchema,
    responses: [
      { status: 200, description: '休暇管理簿', schema: leaveRegisterListSchema },
      invalidRequest,
      unauthorized,
      forbidden,
    ],
  ...
  listOvertimeWarnings: {
    operationId: 'listOvertimeWarnings',
    method: 'get',
    path: '/overtime-warnings',
    summary: '長時間労働の警告を一覧する（上限が未設定なら警告を出さない）',
    tags: ['approval'],
    security: 'sessionOrApiKey',
    query: listMonthlySummariesQuerySchema,
    responses: [
      { status: 200, description: '警告と、見たときの上限', schema: overtimeWarningListSchema },
      invalidRequest,
      unauthorized,
      forbidden,
    ],
